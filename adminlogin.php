...
if (isset($_POST['submit'])) {
  ...
  if (!empty($error)) {
    ...
    $sql = "SELECT * FROM tbl_user WHERE username = '" . $username . "' AND password ='" . $hashpass . "' AND roleId = 1";
    ...
    <div class="row justify-content-md-center">
      <div class="col col-lg-5">
        ...
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
          <li class="nav-item"> <a class="nav-link active" id="pills-Admin-tab" href="adminlogin.php">Admin Login</a> </li>
          <li class="nav-item"> <a class="nav-link " id="pills-Student-tab" href="index.php">Student Login</a> </li>
          <li class="nav-item"> <a class="nav-link" id="pills-Lecturer-tab" href="leclogin.php">Lecturer Login</a> </li>
        </ul>
        <!-- navigation ends -->
