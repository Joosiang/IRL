...
if (isset($_POST['submit'])) {
  ...
  if (!empty($error)) {
    ...
    $sql = "SELECT * FROM tbl_user WHERE username = '" . $username . "' AND password ='" . $hashpass . "' AND roleId = 3";
    ...
    <div class="row justify-content-md-center">
      <div class="col col-lg-5">
        ...
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
          ...
          <li class="nav-item"> <a class="nav-link active" id="pills-Student-tab" href="index.php">Student Login</a> </li>
